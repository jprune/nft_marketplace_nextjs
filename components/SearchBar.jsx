...
const SearchBar = ({ activeSelect, setActiveSelect, handleSearch, clearSearch }) => {
  ...
  return (
    <>
      ...
      <div onClick={() => setToggle((prev) => !prev)} className="relative flexBetween ml-4 py-3 sm:ml-0 sm:mt-2 min-w-190 cursor-pointer dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 px-4 rounded-md">
        ...
        />
        {toggle && (
        <div className="absolute top-full left-0 right-0 w-full mt-3 z-10 dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 py-2 px-4 rounded-md">
