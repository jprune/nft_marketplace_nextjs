...
const FooterLinks = ({ heading, items, textPosition }) => (
  <div className={`flex flex-col justify-${textPosition} items-${textPosition}`}>
    ...
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        ...
        <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml-0 md:mt-8">
          <FooterLinks heading="CryptoKet" items={['Explore', 'How it works', 'Contact Us']} textPosition="start" />
          <FooterLinks heading="CryptoKet" items={['Help Center', 'Terms of Service', 'Legal', 'Privacy Policy']} textPosition="end" />
        </div>
      </div>
